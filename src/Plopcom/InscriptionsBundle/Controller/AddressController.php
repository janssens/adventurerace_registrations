...
use Plopcom\InscriptionsBundle\Form\AddressType;
...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $addresses = $em->getRepository('PlopcomInscriptionsBundle:Address')->findAll();
    ...
    {
        $address = new Address();
        $form = $this->createForm('Plopcom\InscriptionsBundle\Form\AddressType', $address);
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('Plopcom\InscriptionsBundle\Form\AddressType', $address);
